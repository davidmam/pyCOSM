...
{"creator":"https://cosm.com/users/davidmam",
"status":"frozen",
"tags":["auto","raspberry Pi","temperature"],
"created":"2012-09-30T20:22:15.303321Z",
"location":{"disposition":"fixed","domain":"physical","exposure":"indoor"},
"datastreams":[
{"tags":["temperature"],
"min_value":"20.02",
"current_value":"20.02",
"at":"2012-09-30T20:32:46.670606Z",
"unit":{"label":"C"},
"max_value":"20.02",
"id":"1"}
],
"feed":"https://api.cosm.com/v2/feeds/78077.json",
"version":"1.0.0",
"title":"temperature1",
"private":"false",
"updated":"2012-09-30T20:32:46.680373Z",
"id":78077}
...
class COSM:
    ...
    def rest_call(self, method, data=None):
        ...
        if resp.status != successcode:
            raise Exception("Error in COSM http request [%s]: %s"%(resp.status,resp.reason))
        jsontxt=resp.read()
        if self.debug>0:
            print "COSM response:"
            print jsontxt
